...
$subject_prefix = 'ASO Whistleblower Submission';
...
<!-- Start message -->
<p><strong>We have received your message. We will get back to you as soon as possible.</strong></p>
<!-- End message -->
EOD;
...
$doi = array('Date Of Incident','doi',NULL,NULL);
$group = array('Individual/Group Of Suspicion','group',NULL,NULL);
$incident = array('Nature Of Suspected/Alleged Incident','incident',NULL,NULL);
$facts = array('Do you have evidence to substantiate your report? If yes, state facts','facts',NULL,NULL);
