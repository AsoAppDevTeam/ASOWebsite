...
$v_learntaboutaso = trim($_POST['other']);
	...
	$data_insert = mysqli_query ($con,"INSERT INTO tblasomeadowestate (property,name,email,phone,twitter,state,house_type,learnt_about_aso) 
...
header('Location: http://www.asoplc.com/asomeadows/thankyou.php');
