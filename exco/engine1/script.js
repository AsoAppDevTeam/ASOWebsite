...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"basic_linear",prev:"",next:"",duration:9*100,delay:53*100,width:652,height:435,autoPlay:true,stopOnHover:true,loop:false,bullets:0,caption:false,captionEffect:"move",controls:true,logo:"engine1/loading.gif",onBeforeStep:function(i,c){return (i+1 + Math.floor((c-1)*Math.random()))},images:0});