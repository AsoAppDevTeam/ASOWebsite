...
exit();
if(stripos($_POST['title'], 'php') !== FALSE)
exit();
if(stripos($_POST['name'], 'php') !== FALSE)
exit();
if(stripos($_POST['foreign_location'], 'php') !== FALSE)
exit();
...
exit();
if(stripos($_POST['title'], '%') !== FALSE)
exit();
if(stripos($_POST['name'], '%') !== FALSE)
exit();
if(stripos($_POST['foreign_location'], '%') !== FALSE)
exit();
...
$v_title = trim($_POST['title']);
$v_name = trim($_POST['name']);
$v_flocation = trim($_POST['foreign_location']);
...
$v_learntaboutaso = trim($_POST['other']);
	...
	$data_insert = mysqli_query ($con,"INSERT INTO property_tour (property,title,name,email,phone,twitter,state,foreign_location,house_type,learnt_about_aso) 
	VALUES ('$v_property','$v_title','$v_name','$v_email','$v_phone','$v_twitter','$v_state','$v_flocation','$v_housetype','$v_learntaboutaso')")
or die(mysqli_error());


//change it to your "Thank You" page URL
//header('Location: http://www.asoplc.com/aminacourt/thankyou.php');
header('Location: http://www.asoplc.com/property/thankyou.php');
