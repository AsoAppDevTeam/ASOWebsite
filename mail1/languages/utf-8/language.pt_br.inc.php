...
$txt = array (
    ...
    'txt_problems'                     => '<p><strong>Problemas na execução?</strong>Documentação e instruções: <a href="./docu/" target="_blank">./docu/</a></p><p>Obtenha respostas no <a href="http://www.stadtaus.com/forum/" target="_blank">fórum de suporte</a> no website do <a href="http://www.stadtaus.com/en/" target="_blank">Script Form Mail</a>.</p>',
