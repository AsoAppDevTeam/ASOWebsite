...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container2").wowSlider({effect:"basic_linear",prev:"",next:"",duration:9*100,delay:53*100,width:470,height:250,autoPlay:true,stopOnHover:true,loop:false,bullets:true,caption:true,captionEffect:"move",controls:true,logo:"engine2/loading.gif",onBeforeStep:0,images:0});