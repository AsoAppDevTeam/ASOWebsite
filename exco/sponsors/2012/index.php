<?php
  $title = "2012 Exhibition Sponsors - ASO Savings &amp; Loans, PLC";
            ...
            <li><a href="#">Exhibition</a>
              <ul>
                ...
                <li><a href="#">Exhibition 2012</a>
                  <ul>
                    <li class="first activeTrail"><a href="#">2012 Sponsors</a></li>
          ...
          <?php
            $sponsors = array (
	          'Diamond' => array (
				...
				array('xmrb','Metro Realty &amp; Brokers','http://'),
				array('xdefault','',''),
				array('xdefault','',''),
				array('xdefault','',''),
			  ),
			  'Gold' => array (
			    array('xunitek','UNITEK Modular Builders','http://'),
				...
				array('xintegax','INTEGAX Jubilation Homes','http://integaxjubilationhomes.com'),
				array('xupdc','UACN Property Development Company Plc ','http://www.updcplc.com/'),
				array('xdefault','',''),
				array('xdefault','','')
			  ),
			  'Silver' => array (
			    array('xtrendy','Trendy Homes Limited','http://trendyhomesltd.com/'),
				array('xdefault','',''),
				array('xdefault','',''),
				array('xdefault','',''),
				array('xdefault','',''),
