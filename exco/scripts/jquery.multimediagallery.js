		...
		*/
		...
		switch(item_type){
			...
			case 'audio':
				...
				var $audio = '<audio controls>'+$sources+'</audio>';
			...
			case 'video':
				...
				var $video = '<video controls preload="none">'+$sources+'<div class="fallback"><div class="fallback-text"><p>Please use a modern browser or install <a href="http://www.videolan.org/">VLC (check Mozilla Plugin)</a> or <a href="http://get.adobe.com/flashplayer/">Flash-Plugin</a></p></div></div>'+'</video>';
